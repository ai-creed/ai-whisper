...
//
// DUPLICATED verbatim from packages/cli/src/runtime/mid-composition-shape.ts.
// @ai-whisper/cli depends on the adapters, NOT vice versa, so importing this
// predicate from the CLI would create a circular dependency. Keeping a local
// copy keeps behavior identical with no cross-package import. If the CLI copy
